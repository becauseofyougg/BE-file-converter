...
import { PrismaClient } from '@prisma-clients/conversion';

import { ConfigService } from '@core/config/config.service';
import { ConversionConfig } from '../config/conversion.config';

/**
 * The `conversion` database connection. Owns its schema; no other service reads
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  constructor(config: ConfigService<ConversionConfig>) {
    super({
